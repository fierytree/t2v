...
def read_video(video, image_size):
    ...
    for img in reader:
        ...
        pil_im_rsz = pil_im.resize((image_size, image_size), Image.Resampling.LANCZOS)
...
def read_video2(video, image_size1, image_size2):
    ...
    for img in reader:
        img_cc = center_crop(img)
        pil_im = Image.fromarray(img_cc)
        pil_im_rsz1 = pil_im.resize((image_size1, image_size1), Image.Resampling.LANCZOS)
        pil_im_rsz2 = pil_im.resize((image_size2, image_size2), Image.Resampling.LANCZOS)
